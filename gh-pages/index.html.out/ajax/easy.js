...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__5814 = cljs.core.second(format);
var G__5815 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__5814,G__5815) : ajax.easy.keyword_response_format_element.call(null,G__5814,G__5815));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__5816 = format;
var G__5816__$1 = (((G__5816 instanceof cljs.core.Keyword))?G__5816.fqn:null);
switch (G__5816__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5818_SHARP_){
return ajax.easy.keyword_response_format_element(p1__5818_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__5819){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5820__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5820__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5820__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__5820,map__5820__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__5822){
var vec__5823 = p__5822;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5823,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5823,(1),null);
var fexpr__5826_5827 = (cljs.core.truth_(ok)?h:e);
(fexpr__5826_5827.cljs$core$IFn$_invoke$arity$1 ? fexpr__5826_5827.cljs$core$IFn$_invoke$arity$1(result) : fexpr__5826_5827.call(null,result));
...
;})(h,e,map__5820,map__5820__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__5828){
var map__5829 = p__5828;
var map__5829__$1 = ((((!((map__5829 == null)))?(((((map__5829.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5829.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5829):map__5829);
var opts = map__5829__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5829__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5829__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5829__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5829__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5829__$1,cljs.core.cst$kw$body);
